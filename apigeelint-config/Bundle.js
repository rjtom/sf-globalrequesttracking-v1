...
Bundle.prototype.getDescription = function() {
  if (!this.description) {
    //look at the root of the proxy for the .xml file and get description from the element 'Description'
    try {
      var desc = xpath.select("string(/" + this.xPathName + "/Description)", this.getElement());
